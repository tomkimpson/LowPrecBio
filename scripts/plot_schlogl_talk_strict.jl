...
"""
Generate Schlogl strict-mode histogram for talk — problem case only.

Shows FP64 baseline + STRICT BF16 RTN (no SR).
BF16+SR omitted to show the problem before introducing the solution.

Usage:
  julia --project=. scripts/plot_schlogl_talk_strict.jl
"""
...
function main()
    ...
    output_stem = arg_string(opts, "output-stem", "figures/schlogl_talk_strict")

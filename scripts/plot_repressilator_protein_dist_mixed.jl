...
"""
Generate repressilator protein distribution (mixed precision panel) using CairoMakie.

Usage:
  julia --project=. scripts/plot_repressilator_protein_dist_mixed.jl
"""
...
function main()
    ...
    output_stem = arg_string(opts, "output-stem", "figures/repressilator_protein_dist_mixed")
